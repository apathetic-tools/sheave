...
- Normal mode (default): uses src/sheave
- Standalone mode: uses dist/sheave.py when RUNTIME_MODE=singlefile
- Zipapp mode: uses dist/sheave.pyz when RUNTIME_MODE=zipapp
